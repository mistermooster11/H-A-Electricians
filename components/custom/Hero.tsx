      ...
      <div className="inner overflow-visible relative">
        <div className="max-w-8xl max-[767px]:pl-10">
         ...
         <div className='relative z-20'>
          ...
          >
            Manhattan&apos;s Licensed Electricians — Available 24/7
          </h1>
          ...
          <div className="flex justify-start pb-20 max-[767px]:block max-[767px]:pb-8">
            ...
            >
              <p className="text-[1.9rem] leading-[1.6]">
                From panel upgrades and home rewires to EV charger installations
                and generator installs — H&amp;A NYC Electrician delivers licensed,
                insured service throughout Manhattan with upfront pricing and no
                hidden fees. Mon–Sun, 24 hours.
              </p>
            </div>
              ...
              >
                <span
                  ...
                  style={{
                    width: '200%',
                    height: '200%',
                    border: '1px dashed rgba(97,206,112,.2)',
                    borderRadius: '50%',
                  }}
                />
              </span>
