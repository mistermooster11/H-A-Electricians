      ...
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          ...
          <p className="cta-form__subtext hidden md:block">
            24/7 availability — licensed NYC electricians, Mon–Sun
            <br />Upfront pricing — no hidden fees or surprise charges
          </p>
        ...
        <div className="cta-form__right">
          ...
          <p className="cta-form__text">
            Fast-response electrical services available 24/7 across all of Manhattan — panel upgrades, wiring, EV charger installation, and emergency electrical — with no additional fees for nights, weekends, or holidays.
          </p>
          <p className="cta-form__text">
            H&amp;A NYC Electrician serves homeowners, tenants, property managers, and commercial clients throughout Manhattan. Every job comes with a written estimate, licensed technicians, and proper permits pulled where required.
          </p>
