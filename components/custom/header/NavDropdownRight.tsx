...
const NavDropdownRight:React.FC<NavDropdownLeftProps> = ({ dd }) => {
  return (
    <>
      {dd.quickLinks && (
        <div className="w-[32%] box-border py-[4rem] px-[2.5rem] bg-[#EFEFEF]">
            ...
            {dd.quickLinks.map((ql) => (
              <li key={ql.label} className="mb-[2.7rem]">
                ...
                >
                  ...
                  <span className="border-b border-[#133380] transition-colors duration-350 group-hover/ql:border-brand-orange ml-2">
                    {ql.label}
                  </span>
                </a>
              </li>
