      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          ...
          <p className="testimonials__subtext">
            Our clients rely on H&amp;A NYC Electrician for fast response, professional service, and reliable
            electrical solutions — panel upgrades, EV charger installation, emergency service,
            and residential wiring across all of Manhattan.
          </p>
        </div>
