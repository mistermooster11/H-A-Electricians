      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <p className="about__text">
            H&amp;A NYC Electrician provides licensed, insured electrical services for residential and commercial properties
            across all of Manhattan — from Inwood to the Financial District.
          </p>
          <p className="about__text">
            Our team specializes in panel upgrades, residential wiring, EV charger installation,
            and 24/7 emergency electrical service — always with upfront pricing and no hidden fees.
          </p>
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              ...
              alt="H&A NYC Electrician licensed technician"
              width={690}
              height={613}
