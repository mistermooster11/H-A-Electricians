      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Our Electrical Services in Manhattan
          </h2>
          <p className="faq__subtext">
            Find clear answers about our panel upgrades, wiring, EV charger installation,
            emergency electrical service, and pricing across all Manhattan neighborhoods.
          </p>
